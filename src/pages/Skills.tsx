...
const Skills: React.FC = () => {
  ...
  const skills: SkillType[] = [
    ...
    { name: "Angular", icon: <SiAngular />, level: 70, category: "frontend" },
    { name: "Vue.js", icon: <SiVuedotjs />, level: 70, category: "frontend" },

    // Backend
    { name: "JavaScript", icon: <FaJs />, level: 90, category: "backend" },
    { name: "Node.js", icon: <FaNodeJs />, level: 85, category: "backend" },
    { name: "Express", icon: <SiExpress />, level: 80, category: "backend" },
    { name: "Prisma", icon: <SiPrisma />, level: 80, category: "backend" },
    {
      name: "TypeScript",
      icon: <SiTypescript />,
      level: 85,
    ...
    // Herramientas
    { name: "ChatGPT", icon: <FaRobot />, level: 90, category: "tools" },
    { name: "Gemini", icon: <FaRobot />, level: 90, category: "tools" },
    { name: "Claude", icon: <FaRobot />, level: 90, category: "tools" },
    ...
    { name: "Jira", icon: <SiJira />, level: 70, category: "tools" },
    { name: "Notion", icon: <SiNotion />, level: 70, category: "tools" },
  ];
